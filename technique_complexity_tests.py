...
class Tests(unittest.TestCase):
    def test_calculate_complexity(self):
        ...
        techniques_to_tactics_array.append([[],[1583],[],[1072],[1574.002],[],[1036],[1003],[1083],[1570,1072],[],[],[],[]])
        techniques_to_tactics_array.append([[],[1583.001,1583],[],[1072],[1574.002],[1068],[1036],[1003],[],[1072],[],[],[],[]])
        techniques_to_tactics_array.append([[1589],[1583.001,1583],[],[],[],[1068],[1036],[],[1083],[],[1119],[],[],[]])
        techniques_to_tactics_array.append([[1589],[1583],[],[1072],[1574.002],[1068],[1036],[1003],[],[1072],[],[],[],[]])
        ...
        values={1583:0.7,1072:0.8,1574.002:0.9,1036:0.9,1003:0.8,1083:0.4,1570:0.9,1583.001:0.7,1068:0.8,1119:0.6,1589:0.25}
        ...
        expected_complexities_aerospace = (average_complexity_apt3 + average_complexity_turbine_panda)/expected_no_aerospace
        expected_complexities_other = (average_complexity_aeroblade + average_complexity_imperial_kitten + average_complexity_anchor_panda)/expected_no_other
        expected_average_frequency_aerospace = (frequency_apt3 + frequency_turbine_panda)/expected_no_aerospace
        expected_average_frequency_other = (frequency_aeroblade + frequency_imperial_kitten + frequency_anchor_panda)/expected_no_other
